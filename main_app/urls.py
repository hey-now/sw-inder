...
urlpatterns = [
  ...
  path('interests/<int:profile_id>/assoc_toy/<int:interest_id>/', views.assoc_interest, name='assoc_interest'),
  path('interests/<int:profile_id>/remove_toy/<int:interest_id>/', views.remove_interest, name='remove_interest'),
